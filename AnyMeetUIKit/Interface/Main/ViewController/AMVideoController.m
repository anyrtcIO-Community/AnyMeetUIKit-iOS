...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id <UIViewControllerTransitionCoordinator>)coordinator{
    ...
    self.horizontalScrollView.frame = CGRectMake(0, UIScreen.mainScreen.bounds.size.width - scrollH - padding, UIScreen.mainScreen.bounds.size.height, scrollH);
...
- (void)playRemindMusic{
    ...
    NSArray *arr = [NSBundle pathsForResourcesOfType:@"mp3" inDirectory:Bundle_Path];
    if (arr.count != 0) {
