...
- (void)initTopTool{
    ...
    [switchCameraButton setImage:[UIImage imageNamed:@"switch" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    ...
    [spearkerButton setImage:[UIImage imageNamed:@"icon_扬声器" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
    [spearkerButton setImage:[UIImage imageNamed:@"icon_扬声器关闭" inBundle:Bundle compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
